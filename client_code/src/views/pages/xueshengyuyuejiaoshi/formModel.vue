  ...
  <div class="detail-page" :style='{}'>
    ...
    <div class="detail_view">
      ...
      <div class="info_view">
        ...
        <div class="info_item">
          <div class="info_label">Parent Account</div>
        ...
        <div class="info_item" v-if="centerType">
          <div class="info_label">Reply Content</div>
          <div class="info_text">{{detail.shhf}}</div>
        </div>
        <div class="btn_view">
          <el-button class="approval_btn" v-if="btnAuth('xueshengyuyuejiaoshi','Review')" type="warning" @click="approvalClick()">Reply</el-button>
          <el-button v-if="centerType&&(detail.ispay=='Unpaid'||!detail.ispay)&&btnFrontAuth('xueshengyuyuejiaoshi','Pay')" class="approval_btn" @click="payClick">Pay</el-button>
          <el-button class="edit_btn" v-if="centerType&&btnAuth('xueshengyuyuejiaoshi','Modify')" type="primary" @click="editClick">Modify</el-button>
          <el-button class="del_btn" v-if="centerType&&btnAuth('xueshengyuyuejiaoshi','Delete')" type="danger" @click="delClick">Delete</el-button>
        </div>
      </div>
    </div>
...
const downClick = (file) => {
  ...
  axios.get((location.href.split(context?.$config.name).length>1 ? location.href.split(context?.$config.name)[0] :'') + context?.$config.name + '/file/download?fileName=' + arr, {
    ...
    a.download = arr
    // a.click()
    // The following syntax is compatible with Firefox
