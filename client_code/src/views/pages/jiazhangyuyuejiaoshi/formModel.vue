	...
	<div class="detail-page" :style='{}'>
		...
		<div class="detail_view">
			...
			<div class="info_view">
				...
				<div class="btn_view">
					<el-button class="approval_btn" v-if="btnAuth('jiazhangyuyuejiaoshi','审核')" type="warning" @click="approvalClick()">回复</el-button>
					<el-button v-if="centerType&&(detail.ispay=='未支付'||!detail.ispay)&&btnFrontAuth('jiazhangyuyuejiaoshi','支付')" class="approval_btn" @click="payClick">支付</el-button>
					<el-button class="edit_btn" v-if="centerType&&btnAuth('jiazhangyuyuejiaoshi','修改')" type="primary" @click="editClick">修改</el-button>
					<el-button class="del_btn" v-if="centerType&&btnAuth('jiazhangyuyuejiaoshi','删除')" type="danger" @click="delClick">删除</el-button>
				</div>
			</div>
		</div>
