				...
				<el-row>
					...
					<el-col :span="12">
						<el-form-item label="是否置顶" prop="isTop">
							<el-input class="list_inp" v-model.number="form.isTop" placeholder="是否置顶"
								 type="text" 								:readonly="!isAdd||disabledForm.isTop?true:false" />
						</el-form-item>
					</el-col>
...
<script setup>
	...
	const getInfo = ()=>{
		context?.$http({
			...
			res.data.data.content = res.data.data.content?(res.data.data.content.replace(reg,'../../../cl26103485/file')):'';
