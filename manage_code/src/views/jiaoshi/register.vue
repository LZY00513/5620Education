	...
	<div>
		<div class="register_view">
			<el-form :model="registerForm" class="register_form">
				...
				<div class="list_item">
					<div class="list_label">所授科目：</div>
					<el-input class="list_inp"
						 v-model="registerForm.suoshoukemu" 
						 placeholder="请输入所授科目"
						 type="text"
						/>
				</div>
...
.register_form .list_item .el-upload-dragger .el-icon--upload{ font-size: 48px; color: #7686a8; line-height: 40px;  margin: 0px; }
...
.register_form .list_item .el-upload-dragger .el-upload__text em{ color: #7686a8; }
...
.register_form .list_item .list_radio .el-radio.is-checked .el-radio__label { color:#7686a8;   }
...
.register_form .list_item .list_radio .el-radio .el-radio__input.is-checked .el-radio__inner{ border-color: #7686a8; background: #7686a8;  }
...
.register_form .list_item .list_checkbox .el-checkbox.is-checked .el-checkbox__label { color: #7686a8; }
...
.register_form .list_item .list_checkbox .el-checkbox.is-checked .el-checkbox__input .el-checkbox__inner{ border-color: #7686a8; background: #7686a8; }
...
.register_form .list_code .list_code_item .list_code_btn{ width: 120px; height: 40px;  line-height: 40px; padding: 0px;  border: 0px solid rgb(73, 189, 227); background:#7686a8; border-radius: 0px; color: rgb(255, 255, 255); font-size: 15px; }


.register_form .list_btn{  margin-top:20px;   }
.register_form .list_btn .register{ width: auto; height: 42px; line-height: 42px; background: #7686a8; border: 0px solid #ccc; font-weight: 500; font-size: 18px; color: #fff; margin-bottom:20px; padding:0 20px; border-radius:0px; min-width:120px;  float:left;  } 
