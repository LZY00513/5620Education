	...
	<div class="list-page" :style='{}'>
		...
		<el-form :inline="true" :model="searchQuery" class="list_search">
			...
			<div class="search_btn_view">
				...
				<el-button class="add_btn" type="success" v-if="btnAuth('xueshengyuyuejiaoshi','新增')" @click="addClick">新增</el-button>
			</div>
		</el-form>
		<div class="page_list">
			<div class="data_box">
				<div class="data_view">
					<el-table v-loading="listLoading" class="data_table" :data="list" border :row-style="{'cursor':'pointer'}"
						...
						<el-table-column label="可约时间" :resizable='true' align="left" header-align="left">
							<template #default="scope">
						...
						<el-table-column label="家长账号" :resizable='true' align="left" header-align="left">
							<template #default="scope">
						...
						<el-table-column label="回复" v-if="centerType" :resizable='true' align="left" header-align="left">
							<template #default="scope">
								{{scope.row.shhf}}
							</template>
						</el-table-column>
...
<script setup>
	...
	const addClick = () => {
		router.push('/index/xueshengyuyuejiaoshiAdd')
	}
	//判断是否从个人中心跳转
