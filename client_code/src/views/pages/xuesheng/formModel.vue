      ...
      <div class="info_view">
        <div class="title_view">
          <div class="detail_title">
            <span>{{detail.xueshengxingming}}</span>
          </div>
        </div>
        <div class="info_item">
        ...
        <div class="info_item">
          <div class="info_label">Mobile Number</div>
        ...
        <div class="btn_view">
          <el-button v-if="centerType&&(detail.ispay=='Unpaid'||!detail.ispay)&&btnFrontAuth('xuesheng','Pay')" class="approval_btn" @click="payClick">Pay</el-button>
          <el-button class="edit_btn" v-if="centerType&&btnAuth('xuesheng','Edit')" type="primary" @click="editClick">Edit</el-button>
          <el-button class="del_btn" v-if="centerType&&btnAuth('xuesheng','Delete')" type="danger" @click="delClick">Delete</el-button>
        </div>
      </div>
    </div>
  </div>
...
const getDetail = () => {
  context?.$http({
    ...
    title.value = res.data.data.xueshengxingming
...
// Check if jumping from the personal center
