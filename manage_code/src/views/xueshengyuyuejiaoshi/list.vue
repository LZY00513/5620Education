	...
	<div>
		<div class="center_view">
			<div class="list_search_view">
				...
				<div class="btn_view">
					<el-button class="add_btn" type="success" @click="addClick" v-if="btnAuth('xueshengyuyuejiaoshi','新增')">
						<i class="iconfont icon-xinzeng2"></i>
						新增
					</el-button>
					<el-button class="del_btn" type="danger" :disabled="selRows.length?false:true" @click="delClick(null)"  v-if="btnAuth('xueshengyuyuejiaoshi','删除')">
			...
			<el-table
				...
				ref="table"
				v-if="btnAuth('xueshengyuyuejiaoshi','查看')"
				:data="list"
				...
				<el-table-column label="审核" v-if="btnAuth('xueshengyuyuejiaoshi','审核')" :resizable='true' :sortable='true' align="left" header-align="left">
					<template #default="scope">
				...
				<el-table-column label="操作" width="300" :resizable='true' :sortable='true' align="left" header-align="left">
					<template #default="scope">
						<el-button class="view_btn" type="info" v-if=" btnAuth('xueshengyuyuejiaoshi','查看')" @click="infoClick(scope.row.id)">
							<i class="iconfont icon-sousuo3"></i>
							详情
						</el-button>
						<el-button class="edit_btn" type="primary" @click="editClick(scope.row.id)" v-if=" btnAuth('xueshengyuyuejiaoshi','修改')">
							<i class="iconfont icon-xiugai2"></i>
							修改						</el-button>
						<el-button class="del_btn" type="danger" @click="delClick(scope.row.id)"  v-if="btnAuth('xueshengyuyuejiaoshi','删除')">
