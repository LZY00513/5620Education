	...
	<div>
		<div class="center_view">
			<div class="list_search_view">
				<el-form :model="searchQuery" class="search_form" >
					<div class="search_view">
						...
						<div class="search_box">
							<el-input class="search_inp" v-model="searchQuery.ziyuanmingcheng" placeholder="资源名称"
								clearable>
							</el-input>
						</div>
					</div>
				...
				<div class="btn_view">
					<el-button class="add_btn" type="success" @click="addClick" v-if="btnAuth('jiaoxueziyuan','新增')">
						<i class="iconfont icon-xinzeng2"></i>
						新增
					</el-button>
					<el-button class="del_btn" type="danger" :disabled="selRows.length?false:true" @click="delClick(null)"  v-if="btnAuth('jiaoxueziyuan','删除')">
						<i class="iconfont icon-shanchu1"></i>
						删除
					</el-button>
					<el-button class="statis_btn" type="warning" @click="echartClick1" v-if="btnAuth('jiaoxueziyuan','资源类型')">
			...
			<el-table
				...
				<el-table-column label="资源附件" min-width="140" :resizable='true' :sortable='true' align="left" header-align="left">
					<template #default="scope">
						<el-button v-if="scope.row.ziyuanfujian" link size="small" @click="download(scope.row.ziyuanfujian)">下载</el-button>
				...
				<el-table-column label="操作" width="300" :resizable='true' :sortable='true' align="left" header-align="left">
					<template #default="scope">
						<el-button class="view_btn" type="info" v-if=" btnAuth('jiaoxueziyuan','查看')" @click="infoClick(scope.row.id)">
							<i class="iconfont icon-sousuo3"></i>
							详情
						</el-button>
						<el-button class="edit_btn" type="primary" @click="editClick(scope.row.id)" v-if=" btnAuth('jiaoxueziyuan','修改')">
							<i class="iconfont icon-xiugai2"></i>
							修改						</el-button>
						<el-button class="del_btn" type="danger" @click="delClick(scope.row.id)"  v-if="btnAuth('jiaoxueziyuan','删除')">
		...
		<!-- 统计图弹窗 -->
		<el-dialog v-model="echartVisible" :title="'资源类型'" width="70%">
			<div  id="ziyuanleixingEchart1" style="width:100%;height:600px;"></div>
			<template #footer>
...
<script setup>
	...
	const echartClick1 = ()=>{
		...
		nextTick(()=>{
			var ziyuanleixingEchart1 = echarts.init(document.getElementById("ziyuanleixingEchart1"),'macarons');
			context?.$http({
