...
.forget_view .list_btn .get_btn{ width: auto; height: 42px; line-height: 42px; background: #7686a8; border: 0px solid #ccc; font-weight: 500; font-size: 18px; color: #fff; margin-bottom:20px; padding:0 20px; border-radius:0px; min-width:120px;  float:left;  } 
.forget_view .list_btn .get_btn:hover {  } 

.forget_view .list_btn .valid_btn{  width: auto; height: 42px; line-height: 42px; background: #7686a8; border: 0px solid #ccc; font-weight: 500; font-size: 18px; color: #fff; margin-bottom:20px; padding:0 20px; border-radius:0px; min-width:120px;  float:left;  } 
.forget_view .list_btn .valid_btn:hover {  } 

.forget_view .list_btn .update_btn{  width: auto; height: 42px; line-height: 42px; background: #7686a8; border: 0px solid #ccc; font-weight: 500; font-size: 18px; color: #fff; margin-bottom:20px;  padding:0 20px; border-radius:0px; min-width:120px;  float:left;  } 
...
.forget_view .list_btn .r-login:hover{ cursor:pointer; color: #7686a8;  } 
