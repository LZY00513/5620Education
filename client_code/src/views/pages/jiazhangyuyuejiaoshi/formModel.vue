  ...
  <div class="detail-page" :style='{}'>
    ...
    <div class="detail_view">
      ...
      <div class="info_view">
        ...
        <div class="info_item">
          <div class="info_label">Parent Name</div>
        ...
        <div class="btn_view">
          <el-button class="approval_btn" v-if="btnAuth('jiazhangyuyuejiaoshi','Review')" type="warning" @click="approvalClick()">Reply</el-button>
          <el-button v-if="centerType&&(detail.ispay=='Not Paid'||!detail.ispay)&&btnFrontAuth('jiazhangyuyuejiaoshi','Pay')" class="approval_btn" @click="payClick">Pay</el-button>
          <el-button class="edit_btn" v-if="centerType&&btnAuth('jiazhangyuyuejiaoshi','Edit')" type="primary" @click="editClick">Edit</el-button>
          <el-button class="del_btn" v-if="centerType&&btnAuth('jiazhangyuyuejiaoshi','Delete')" type="danger" @click="delClick">Delete</el-button>
        </div>
      </div>
    </div>
...
const downClick = (file) => {
  ...
  axios.get((location.href.split(context?.$config.name).length>1 ? location.href.split(context?.$config.name)[0] :'') + context?.$config.name + '/file/download?fileName=' + arr, {
    ...
    a.download = arr
    // a.click()
    // Below code is for Firefox compatibility
