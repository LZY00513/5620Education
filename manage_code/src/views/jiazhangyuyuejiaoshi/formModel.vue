				...
				<el-row>
					...
					<el-col :span="12">
						<el-form-item label="家长账号" prop="jiazhangzhanghao">
							<el-input class="list_inp" v-model="form.jiazhangzhanghao" placeholder="家长账号"
...
<script setup>
	...
	const init=(formId=null,formType='add',formNames='',row=null,table=null,statusColumnName=null,tips=null,statusColumnValue=null)=>{
		...
		context?.$http({
			...
			if(json.hasOwnProperty('jiazhangzhanghao')&& context?.$toolUtil.storageGet("role")!="管理员"){
				form.value.jiazhangzhanghao = json.jiazhangzhanghao
				disabledForm.value.jiazhangzhanghao = true;
			}
			if(json.hasOwnProperty('jiazhangxingming')&& context?.$toolUtil.storageGet("role")!="管理员"){
				form.value.jiazhangxingming = json.jiazhangxingming
				disabledForm.value.jiazhangxingming = true;
			}
