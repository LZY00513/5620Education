  ...
  <div class="detail-page" :style='{}'>
    ...
    <div class="detail_view">
      ...
      <div class="info_view">
        ...
        <div class="btn_view">
          <el-button v-if="centerType&&(detail.ispay=='未支付'||!detail.ispay)&&btnFrontAuth('xueshengkongbaiyemian','支付')" class="approval_btn" @click="payClick">Pay</el-button>
          <el-button class="edit_btn" v-if="centerType&&btnAuth('xueshengkongbaiyemian','修改')" type="primary" @click="editClick">Edit</el-button>
          <el-button class="del_btn" v-if="centerType&&btnAuth('xueshengkongbaiyemian','删除')" type="danger" @click="delClick">Delete</el-button>
        </div>
      </div>
    </div>
...
const formName = 'Student Blank Page'
// Basic information
const breadList = ref([{
  name: formName
}])
