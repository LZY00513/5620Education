	...
	<div class="detail-page" :style='{}'>
		...
		<div class="detail_view">
			...
			<div class="info_view">
				...
				<div class="info_item">
					<div class="info_label">资源类型</div>
					<div  class="info_text" >{{detail.ziyuanleixing}}</div>
				</div>
				<div class="info_item">
					<div class="info_label">资源简述</div>
				...
				<div class="info_item">
					<div class="info_label">资源附件</div>
					<div class="info_text">
						<el-button class="info_down" v-if="detail.ziyuanfujian" @click="downClick(detail.ziyuanfujian)">点击下载</el-button>
						<el-button class="info_undown" v-else>暂无</el-button>
					</div>
				</div>
				<div class="btn_view">
					<el-button v-if="centerType&&(detail.ispay=='未支付'||!detail.ispay)&&btnFrontAuth('jiaoxueziyuan','支付')" class="approval_btn" @click="payClick">支付</el-button>
					<el-button class="edit_btn" v-if="centerType&&btnAuth('jiaoxueziyuan','修改')" type="primary" @click="editClick">修改</el-button>
					<el-button class="del_btn" v-if="centerType&&btnAuth('jiaoxueziyuan','删除')" type="danger" @click="delClick">删除</el-button>
				</div>
			</div>
		</div>
		<div class="detail-box">
			<div class="title"><span>资源详情</span></div>
