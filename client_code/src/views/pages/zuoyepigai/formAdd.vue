      ...
      <el-row>
        ...
        <el-col :span="24">
          <el-form-item label="Score" prop="pingfen">
            <el-input class="list_inp" v-model.number="form.pingfen" placeholder="Score"
                      type="text" 							:readonly="!isAdd||disabledForm.pingfen?true:false" />
          </el-form-item>
        </el-col>

        <el-col :span="24">
          <el-form-item label="Correction Time" prop="pigaishijian">
            <el-date-picker
                class="list_date"
                v-model="form.pigaishijian"
                format="YYYY-MM-DD HH:mm:ss"
                value-format="YYYY-MM-DD HH:mm:ss"
                type="datetime"
                style="width:100%;"
                :readonly="!isAdd||disabledForm.pigaishijian?true:false"
                placeholder="Please select correction time" />
          </el-form-item>
        </el-col>
        <el-col :span="24">
          <el-form-item label="Correction Content" prop="pigaineirong">
            <el-input v-model="form.pigaineirong" placeholder="Correction Content" type="textarea"
                      :readonly="!isAdd||disabledForm.pigaineirong?true:false"
            />
          </el-form-item>
        </el-col>
      </el-row>
...
const formName = 'Homework Correction'
// Basic information
const breadList = ref([{
  name: formName
}])
...
const init = (formId=null,formType='add',formNames='',row=null,table=null,statusColumnName=null,tips=null,statusColumnValue=null) => {
  form.value.pigaishijian = context?.$toolUtil.getCurDateTime()
  if(formId){
    id.value = formId
    type.value = formType
  }
  if(formType == 'add'){
    ...
    for(let x in row){
      ...
      if(x=='pigaishijian'){
        form.value.pigaishijian = row[x];
        disabledForm.value.pigaishijian = true;
        continue;
      }
      if(x=='crossuserid'){
